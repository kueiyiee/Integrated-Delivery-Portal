...
class AuthenticationService
{
    ...
    public function register(array $data): User
    {
        ...
        $managerPermissions = [
            ...
            'manage.company' => 'Manage company profile and ownership controls',
            'manage.users' => 'Invite and manage company users',
            'manage.api_keys' => 'Manage company API credentials',
