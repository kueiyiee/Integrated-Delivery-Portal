...
export default function LoginPage() {
  ...
  const submit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setError(null);
    if (!isLoginEnabled) {
      setError('Please enter your email and password before signing in.');
      return;
    }
    setLoading(true);
    try {
      ...
      const message = err?.message || 'Unable to sign in. Please verify your credentials and try again.';
      setError(message);
      toast.error({
