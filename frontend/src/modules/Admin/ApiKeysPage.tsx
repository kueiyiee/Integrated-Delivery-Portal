              ...
              return (
                <div key={key.id} className={`admin-api-key-entry ${isExpanded ? 'admin-api-key-entry--expanded' : ''}`} role="listitem">
                  ...
                  >
                    ...
                    <span className="admin-api-key-entry__date">{key.created_at ? new Date(key.created_at).toLocaleDateString() : '—'}</span>
                  ...
                  {isExpanded ? (
                    <div id={`api-key-details-${key.id}`} className="admin-api-key-entry__details">
                      <div className="admin-api-key-entry__details-grid">
                        ...
                        <div><span>Last updated</span><strong>{key.updated_at ? new Date(key.updated_at).toLocaleString() : '—'}</strong></div>
                      </div>
                    </div>
                  ) : null}
                </div>
