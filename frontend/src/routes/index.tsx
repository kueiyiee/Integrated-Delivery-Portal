...
const LoginPage = lazy(() => import('../authentication/pages/Login').then(m => ({ default: m.default })));
...
const ClientDashboardPage = lazy(() => import('../modules/Client/CompanyManagerPage').then(m => ({ default: m.ClientDashboardPage })));
const ClientDeliveriesPage = lazy(() => import('../modules/Client/CompanyManagerPage').then(m => ({ default: m.ClientDeliveriesPage })));
const ClientDocumentsPage = lazy(() => import('../modules/Client/CompanyManagerPage').then(m => ({ default: m.ClientDocumentsPage })));
const ClientReportsPage = lazy(() => import('../modules/Client/CompanyManagerPage').then(m => ({ default: m.ClientReportsPage })));
const ClientProfilePage = lazy(() => import('../modules/Client/CompanyManagerPage').then(m => ({ default: m.ClientProfilePage })));
